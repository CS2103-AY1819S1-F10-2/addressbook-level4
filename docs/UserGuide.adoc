...
* Login authentication to ensure that unauthorized people do not delete the loans which they are not supposed to. LoanBook requires a password when deleting.
