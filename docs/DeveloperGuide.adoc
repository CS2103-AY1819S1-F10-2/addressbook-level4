...
== Setting up
This section describes the necessary dependencies required to install the application, together with the steps required to install.
...
== Design
This section depicts the implementation of the application, from UI to storage.
...
This section describe the way we document our project. We use asciidoc for writing documentation.
...
This sections provides a brief summery of the tools we use in the project, and how to integrate them to this project.
