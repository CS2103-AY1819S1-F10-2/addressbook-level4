...
public abstract class AddressBookSystemTest {
    ...
    protected void showAllPersons() {
        ...
        assertEquals(getModel().getAddressBook().getLoanList().size(), getModel().getFilteredPersonList().size());
    }
    ...
    protected void showPersonsWithName(String keyword) {
        ...
        assertTrue(getModel().getFilteredPersonList().size() < getModel().getAddressBook().getLoanList().size());
    }
