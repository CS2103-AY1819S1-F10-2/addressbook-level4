...
public class ModelHelper {
    private static final Predicate<Loan> PREDICATE_MATCHING_NO_PERSONS = unused -> false;
    ...
    public static void setFilteredList(Model model, List<Loan> toDisplay) {
        ...
        model.updateFilteredLoanList(predicate.orElse(PREDICATE_MATCHING_NO_PERSONS));
    }
