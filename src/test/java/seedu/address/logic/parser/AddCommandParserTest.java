...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Loan expectedLoan = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Loan expectedLoanMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Loan expectedLoan = new PersonBuilder(AMY).withTags().build();
