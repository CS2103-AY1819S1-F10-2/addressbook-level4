...
public class CommandTestUtil {
    ...
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "Z3233897A"; // First letter must be S, T, F or G
    ...
    static {
        DESC_AMY = new EditLoanDescriptorBuilder().withName(VALID_NAME_AMY).withNric(VALID_NRIC_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditLoanDescriptorBuilder().withName(VALID_NAME_BOB).withNric(VALID_NRIC_BOB)
    ...
    public static void showLoanAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = loan.getLoanerName().value.split("\\s+");
