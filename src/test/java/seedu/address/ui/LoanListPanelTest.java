...
public class LoanListPanelTest extends GuiUnitTest {
    ...
    public void display() {
        ...
        for (int i = 0; i < TYPICAL_LOANS.size(); i++) {
            personListPanelHandle.navigateToCard(TYPICAL_LOANS.get(i));
            Loan expectedLoan = TYPICAL_LOANS.get(i);
            PersonCardHandle actualCard = personListPanelHandle.getPersonCardHandle(i);

            assertCardDisplaysPerson(expectedLoan, actualCard);
     ...
     */
    private ObservableList<Loan> createBackingList(int personCount) throws Exception {
