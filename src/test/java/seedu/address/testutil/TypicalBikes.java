...
public class TypicalBikes {
    ...
    public static final Bike BIKE1 = new BikeBuilder().withName(VALID_NAME_BIKE3).build();
    public static final Bike BIKE2 = new BikeBuilder().withName(VALID_NAME_BIKE4).build();
